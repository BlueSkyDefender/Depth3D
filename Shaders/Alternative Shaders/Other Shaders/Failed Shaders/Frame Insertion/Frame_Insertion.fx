...
uniform float Frame_Adjust <
	...
	ui_label = "Contrast";
	ui_tooltip = "Use to adjust the Frame from black to white or vice versa.\n"
				 "Zero is black, default.";
> = 0.0;
...
/////////////////////////////////////////////////////////////////////////////////Adapted Luminance/////////////////////////////////////////////////////////////////////////////////
texture texLuminance {Width = 256*0.5; Height = 256*0.5; Format = RGBA8; MipLevels = 8;}; //Sample at 256x256/2 and a mip bias of 8 should be 1x1 
...
{
	float Average_Lum_BW = dot(tex2D(BackBuffer,texcoord).rgb,Luma());
	float3 Average_Lum = tex2D(BackBuffer,texcoord).rgb , Color;
