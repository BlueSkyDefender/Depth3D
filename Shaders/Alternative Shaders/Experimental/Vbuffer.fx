...
{	
		...
		float DM, zBuffer = tex2D(ZBuffer, texcoord).x; //Depth Buffer
...
{	
	float X = tex2Dlod(MaskBuffer,float4(texcoord,0,Fill)).b > (Power+0.01) ? 1 : 0;
...
technique Pseudo_Motion_Detection
{
		pass zbuffer
	{
