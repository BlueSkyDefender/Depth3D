...
* Depth		               -[◄0▪▪▪▪▪▪▪50►]+			Depth Default is 15. "Drag to Adjust Depth."
...
* Disocclusion Power           -[◄▪0.025▪▪▪▪▪►]+		[0:50] Determines the disocclusion effect on the Depth Map. Default is 0.025 zero is Off.
