...
//--------------------////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//* Depth Map Based 3D post-process shader v2.4.6
...
{   float Perf = 1.670, MS = Diverge * pix.x, VM_Adjust = 1.0, GetDepth = smoothstep(0,1,tex2D(SamplerzBufferVR,Coordinates).x).x,Near_Far_CB_Size = GetDepth >= 0.5 ? 1.0 : 0.5;
