...
uniform int WeaponDM <
	ui_type = "combo";
	ui_items = "Custom Off\0Custom One\0Custom Two\0Custom Three\0Custom Four\0";
	ui_label = "Custom Weapon Depth Map";
	ui_tooltip = "Adjust your own Weapon Custom Depth Map.";
> = 0;
...
float4 PS(float4 pos : SV_Position, float2 texcoord : TEXCOORD0) : SV_Target
{
    ...
    float4 DM = lerp(depthM,WA,WDM*Adj);
